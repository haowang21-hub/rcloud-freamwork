...
public final class DateTimeUtils extends DateUtils {
     ...
     * 年月日(yyyyMMdd)
     */
    public static final String YMD_SIMPLE_FORMAT = "yyyyMMdd";
     ...
     */
    public static final String YMDH_CN_FORMAT = "yyyy年MM月dd日HH时";
     ...
     */
    public static final String DEFAULT_FORMAT = YMDHMS_FORMAT;

    /**
     * 年月日小时分钟秒钟(yyyyMMddHHmmss)
     */
    public static final String YMDHMS_SIMPLE_FORMAT = "yyyyMMddHHmmss";
     ...
     * 月.日(M.d)
     */
    public static final String M_D_FORMAT = "M.d";
    ...
    public static DateTime getDateOnly(DateTime dateTime) {
        return new DateTime(dateTime.toString(YMD_FORMAT));
    }
    ...
    public static Date[] getMondayAndNextMonday() {
        ...
        return new Date[] {
            monday.toDate(), nextMonday.toDate()
        };
    }
