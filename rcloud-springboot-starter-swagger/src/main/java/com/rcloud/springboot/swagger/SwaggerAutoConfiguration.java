package com.rcloud.springboot.swagger;
...
import com.rcloud.springboot.swagger.SwaggerProperties.UiConfig;
...
public class SwaggerAutoConfiguration implements BeanFactoryAware {
    ...
    public UiConfiguration uiConfiguration(SwaggerProperties swaggerProperties) {
        UiConfig ui = swaggerProperties.getUiConfig();
        return UiConfigurationBuilder.builder().validatorUrl(ui.getValidatorUrl())
            .docExpansion(DocExpansion.of(ui.getDocExpansion()))
            .defaultModelRendering(ModelRendering.of(ui.getDefaultModelRendering())).build();
    }
    ...
    public List<Docket> createRestApi(SwaggerProperties swaggerProperties) {
        ...
        if (swaggerProperties.getDocket().size() == 0) {
            ...
            Docket docketForBuilder = new Docket(DocumentationType.SWAGGER_2).host(swaggerProperties.getHost())
                .apiInfo(apiInfo).globalOperationParameters(buildGlobalOperationParametersFromSwaggerProperties(
        ...
        for (String groupName : swaggerProperties.getDocket().keySet()) {
            ...
            Docket docketForBuilder = new Docket(DocumentationType.SWAGGER_2).host(swaggerProperties.getHost())
                .apiInfo(apiInfo).globalOperationParameters(assemblyGlobalOperationParameters(
                    swaggerProperties.getGlobalOperationParameters(), docketInfo.getGlobalOperationParameters()));
